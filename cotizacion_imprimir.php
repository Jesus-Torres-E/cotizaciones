...
if (!isset($_SESSION['nombre_cliente']) && !isset($_SESSION['descripcion_coche']) && !isset($_SESSION['fecha_actual'])) {
    ...
    $sel = $con->prepare("SELECT cotzacion_detalle_temporal.cotzacion_detalle_temporal_id, refaccion.refaccion_nombre, (precio)+
(cotzacion_detalle_incremento_temporal) AS costo_pieza, cotzacion_detalle_temporal.cotzacion_detalle_numero_piezas_temporal,
cotzacion_detalle_temporal.cotzacion_detalle_mano_obra, (((precio)+
(cotzacion_detalle_incremento_temporal))*(cotzacion_detalle_numero_piezas_temporal))+(cotzacion_detalle_mano_obra) AS
costo_parcial
...
<head>
    <meta charset="UTF-8">
    <ttle>Imprimir cotzaci&oacute;n</ttle>
    <!-- CSS de Bootstrap -->
...
<body>
    ...
    <br><br>
    <div class="h2">
        <center><b><label>Cotzaci&oacute;n</label></b></center>
    </div>
    <br>
    <div class="h4">
        <table>
            <tr>
                ...
                <td><u> <?php echo $_SESSION['fecha_actual'] ?> </u></td>
            </tr>
            <tr>
                <td>Nombre del cliente: </td>
                <td><u><?php echo $_SESSION['nombre_cliente'] ?></u></td>
            </tr>
            <tr>
                <td>Descripci&oacute;n del coche: </td>
                <td><u><?php echo $_SESSION['descripcion_coche'] ?> </u></td>
            </tr>
        </table>
    </div>
    <br>
        ...
        <table class="table table-hover" border="1" cellpadding="10">
            ...
            <tbody>
                <?php while ($f = $res->fetch_assoc()) { ?>
                    <tr>
                        <td><?php echo $f['cotzacion_detalle_temporal_id'] ?></td>
    ...
    <div class="h5">
        <p>
            La presente cotzaci&oacute;n no representa en forma alguna, reserva de inventario<br>
