    ...
    <body>
        ...
        <div class="container">
            <div class="jumbotron">
                ...
                <form role="form" id="login-form" method="post" class="form-signin" action="refacciones_cotizar_guardar.php">
                    <div class="h2">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="refaccion_id" class="form-control" name="refaccion_id" value="<?php echo $id_refaccion_seleccionada ?>" readonly="" placeholder="<?php echo $nombre_refaccion_seleccionada ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label>Precio</label>
                        <input type="number" class="form-control" id="precio" name="precio" placeholder="Ingresa precio actual" step="0.01" required>
                    </div>
                    <br>
